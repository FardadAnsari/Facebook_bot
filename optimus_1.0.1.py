...
def facebook_fun1(shops_list,account_user,account_pass,comments,my_webdriver):
    ...
    # should add script for checking comments here for each shop
        ...
        for i in range(0,len(shops_list)):
            ...
            while black_hole:
                ...
                if len(comments)!=0:
                    ...
                    print("You do not include comment for your interactions")
                    black_hole=False
                    pass
        ...
        print("Interaction was not successfull")
##-------------------------Main--PART-------------------------------------------------------------------------------------
...
user_x=input("How many Accounts you have  entered into list: ")
user_x=int(user_x)

comment_x=input("How many comment you've got in the list : ")
comment_x=int(comment_x)

comments=comments[0:comment_x]

user=user[0:user_x]

password=password[0:user_x]
